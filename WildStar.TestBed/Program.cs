...
namespace WildStar.TestBed
{
    class Program
    {
        ...
        static void CharacterCustomizationChanges()
        {
            ...
            // aurin female
            // hair
            cch.AddColourOption(itemDisplay, 4, 1, 4, 109, 3); // red (from draken hair)
            cch.AddColourOption(itemDisplay, 4, 1, 4, 55, 3); // brown (aurin F skin)
            cch.AddColourOption(itemDisplay, 4, 1, 4, 48, 3); // hot pink (mordesh hair/F tubes)
            ...
            cch.AddColourOption(itemDisplay, 4, 1, 4, 85, 2); // swamp green (makes a grey-blond, from mordesh skin)
            ...
            // skin
            cch.AddColourOption(itemDisplay, 4, 1, 2, 85, 2); // swamp green (from mordesh skin)
            ...
            // Draken female
            // hair
            cch.AddColourOption(itemDisplay, 5, 1, 4, 55, 2); // brown (aurin F skin)
            ...
            cch.AddColourOption(itemDisplay, 5, 1, 4, 85, 2); // swamp green (makes a grey-brown, from mordesh skin)
            cch.AddColourOption(itemDisplay, 5, 1, 4, 48, 3); // hot pink (mordesh hair/F tubes)
            ...
            // Mechari female
            // skin
            cch.AddColourOption(itemDisplay, 12, 1, 2, 55, 3); // bronze (aurin F skin)
            ...
            cch.AddColourOption(itemDisplay, 12, 1, 2, 48, 3); // hot pink (mordesh hair/F tubes)
            cch.AddColourOption(itemDisplay, 12, 1, 2, 90, 2); // aqua (mordesh teal eyes)
            cch.AddColourOption(itemDisplay, 12, 1, 2, 85, 2); // swamp green (from mordesh skin)
            ...
            // Mordesh female
            // hair
            cch.AddColourOption(itemDisplay, 16, 1, 4, 55, 2); // brown (aurin F skin)
            cch.AddColourOption(itemDisplay, 16, 1, 4, 94, 2); // orange (mordesh orange eyes)
            cch.AddColourOption(itemDisplay, 16, 1, 4, 85, 2); // swamp green (makes a grey-blond, from mordesh skin)
            // skin
            cch.AddColourOption(itemDisplay, 16, 1, 2, 55, 3); // brown (aurin F skin)
            //male to female skin
            ...
            // Mordesh male
            // hair
            cch.AddColourOption(itemDisplay, 16, 0, 4, 55, 2); // brown (aurin F skin)
            cch.AddColourOption(itemDisplay, 16, 0, 4, 94, 2); // orange (mordesh orange eyes)
            cch.AddColourOption(itemDisplay, 16, 0, 4, 85, 2); // swamp green (makes a grey-blond, from mordesh skin)
            // skin
            cch.AddColourOption(itemDisplay, 16, 0, 2, 55, 3); // brown (aurin F skin)
            //female to male skin
