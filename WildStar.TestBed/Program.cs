...
namespace WildStar.TestBed
{
    class Program
    {
        ...
        static void MakeArchive()
        {
            ...
            AddGroundOption("!NEW! Borellian Flora", 1292, 1294, 323, 24);
            AddGroundOption("!NEW! Mycelium Meadow", 1293, 818, 324, 24);
            AddGroundOption("!NEW! Grimvault Scrub", 810, 809, 325, 24);
            AddGroundOption("!NEW! Grimvault Chaparral", 219, 810, 326, 24);
            AddGroundOption("!NEW! Grimvault Basin", 1296, 903, 327, 24);
            AddGroundOption("!NEW! Wild Wheat Country", 101, 195, 328, 24);
            AddGroundOption("!NEW! Obsidian Lowland", 195, 106, 329, 24);
            AddGroundOption("!NEW! Pine Barrens", 45, 514, 330, 24);
            AddGroundOption("!NEW! Dreadmoor Mudflat", 257, 251, 331, 24);
            AddGroundOption("!NEW! Dreadmoor Hammock", 261, 251, 332, 24);
            AddGroundOption("!NEW! Dreadmoor Pasture", 252, 253, 333, 24);
            AddGroundOption("!NEW! Murkmire Highland", 192, 1295, 334, 24);
            AddGroundOption("!NEW! Crimson Badlands", 621, 276, 335, 24);
            AddGroundOption("!NEW! Coralus Dunegrass", 748, 750, 336, 24);
            AddGroundOption("!NEW! Coralus Brush", 751, 752, 337, 24);
            AddGroundOption("!NEW! Coralus Jungle", 750, 751, 338, 24);
            AddGroundOption("!NEW! Blurple Wondershrooms", 1299, 1300, 339, 24);
            AddGroundOption("!NEW! Windswept Tundra", 991, 1172, 340, 24);
