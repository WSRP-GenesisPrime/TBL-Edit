...
namespace WildStar.TestBed
{
    class Program
    {
        ...
        static void MakeArchive()
        {
            ...
            AddGroundOption("Desert Sigils", 347, 766, 313);
            AddGroundOption("Amethyst Meadow", 1034, 1290, 314);
            AddGroundOption("Galeras Prairie", 544, 757, 315);
            AddGroundOption("Galeras Field", 1233, 757, 316);
            AddGroundOption("Galeras Steppe", 757, 82, 317);
            AddGroundOption("Marble Barrens", 1289, 525, 318);
            AddGroundOption("Metal", 501, 572, 319);
            AddGroundOption("Gildgrass Moor", 711, 184, 320);
            ...
            AddEmote(884, null, null, 447);
            AddEmote(6690, null, null, 448);
            AddEmote(5911, null, null, 449);
            AddEmote(5683, null, null, 450);
            AddEmote(5686, null, null, 451);
